# CloudFront Distribution for app.ahauros.ai
...
# CloudFront Origin Access Control - Not needed for S3 website hosting
# resource "aws_cloudfront_origin_access_control" "app" {
#   name                              = "${local.project_name}-app-oac"
#   description                       = "OAC for ${local.project_name} app"
